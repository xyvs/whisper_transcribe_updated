(function () {
  ...
  function createBatchButton() {
    ...
    btn.id = BATCH_BTN_ID;
    btn.type = 'button';
    btn.title = 'Transcribe selected scenes (Whisper JAV)';
  ...
  function ensureBatchButton() {
    ...
    if (toolbar) {
      btn.className = 'ms-whisper-jav-batch btn btn-secondary';
